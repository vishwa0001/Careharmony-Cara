...
def main() -> int:
    ...
    assert len(compares) == 2, "Cara uses one tool router plus one EndConversation safety router"
    compare_values = {a["Parameters"]["ComparisonValue"] for a in compares}
    assert compare_values == {"$.Lex.SessionAttributes.Tool", "$.Lex.SessionAttributes.endReason"}
    ...
    assert first_routes["IdentityDenied"] == "a0000000-0000-4000-8000-000000000001"
    assert first_routes["PatientUnavailable"] == "a0000000-0000-4000-8000-000000000011"
    assert first_routes["ThirdPartyDetected"] == "a0000000-0000-4000-8000-000000000001"
    assert first_routes["RepresentativeDetected"] == "c0000000-0000-4000-8000-000000000001"
    assert first_routes["WrongNumber"] == "c0000000-0000-4000-8000-000000000002"
    ...
    assert second_routes["PatientUnavailable"] == "a0000000-0000-4000-8000-000000000011"
    assert second_routes["ThirdPartyDetected"] == "a0000000-0000-4000-8000-000000000001"
    assert second_routes["IdentityDenied"] == "a0000000-0000-4000-8000-000000000001"
    assert second_routes["IdentityAmbiguous"] == "a0000000-0000-4000-8000-000000000001"
    assert second_routes["FallbackIntent"] == "a0000000-0000-4000-8000-000000000001"
    assert identity_2["Transitions"]["NextAction"] == "a0000000-0000-4000-8000-000000000001"
    ...
    assert invokes[0]["Parameters"]["LambdaInvocationAttributes"]["operation"] == "initialize"
