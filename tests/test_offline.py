...
class CaraHealthBotOfflineTests(unittest.TestCase):
    ...
    def test_full_internal_rename_uses_cara_health_bot_resources(self):
        ...
        self.assertEqual(self.cfg.identity_bot_name, "cara-health-bot-identity")
    ...
    def test_identity_questions_and_unavailable_scenarios_do_not_repeat(self):
        ...
        for identity_id in (
            ...
            self.assertEqual(routes["PatientUnavailable"], "a0000000-0000-4000-8000-000000000011")
    ...
    def test_flow_uses_semantic_identity_then_q_outcome_tools(self):
        ...
        self.assertEqual(routes["IdentityDenied"], "a0000000-0000-4000-8000-000000000001")
        self.assertEqual(routes["RepresentativeDetected"], "c0000000-0000-4000-8000-000000000001")
        self.assertEqual(routes["WrongNumber"], "c0000000-0000-4000-8000-000000000002")
        ...
        self.assertEqual(second_routes["IdentityAmbiguous"], "a0000000-0000-4000-8000-000000000001")
        self.assertEqual(second_routes["FallbackIntent"], "a0000000-0000-4000-8000-000000000001")
        self.assertEqual(second["Transitions"]["NextAction"], "a0000000-0000-4000-8000-000000000001")
    ...
    def test_flow_has_only_one_session_context_lambda_call(self):
        invokes = [a for a in self._flow()["Actions"] if a["Type"] == "InvokeLambdaFunction"]
        self.assertEqual(len(invokes), 1)
        attrs = invokes[0]["Parameters"]["LambdaInvocationAttributes"]
        self.assertEqual(attrs["operation"], "initialize")
        self.assertNotIn("confirmIdentity", json.dumps(self._flow()))
    ...
    def test_lambda_marks_identity_already_confirmed(self):
        ...
        self.assertEqual(data["identityPolicyVersion"], "v6-cara-conversational")
