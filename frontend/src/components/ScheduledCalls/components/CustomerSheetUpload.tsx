      ...
      {!selectedFile ? (
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 mb-3">Only .csv files containing empi, first_name, last_name, gender, phone_number, practice_name, practice_callback_number are supported</p>
